...
public class SummaryPresenter implements Initializable
{
   ...
   public void initialize(URL location, ResourceBundle resources)
   {
      ...
      this.registrationList.selectionModelProperty().addListener(
            new ChangeListener<MultipleSelectionModel<Registration>>()
            {
               @Override
               public void changed(
                     ObservableValue<? extends MultipleSelectionModel<Registration>> observable,
                     MultipleSelectionModel<Registration> oldValue,
                     MultipleSelectionModel<Registration> newValue)
               {
   ...
   private void loadRegistrations()
   {
      ...
      this.registrationList
            .setItems(FXCollections.observableList(this.registrationService.getAll()));
   }

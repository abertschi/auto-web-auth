 ...
 * </pre>
 * 
 * <b>Lifecycle</b> View gets created: OnViewCreated method is called View gets
 * released: OnViewReleased method is called View gets paused: OnViewPaused
 * method is called View gets resumed: OnViewResumed method is called
 * 
...
public class ScreenContext
{
    ...
    /**
     * Show given view on top of screen. {@link ScreenContext#release(Class)}
     * 
     * @return Used stage
     */
     ...
     * @param validArgument Argument, which should be passed to method, if
     *            possible
     */
    private <T extends Annotation> void callAnnotatedMethod(Object object,
    ...
    /**
     * Initialize an array with null values exept for given {@code parameter} on
     * index {@code parameterIndex}.
     * 
    ...
    /**
     * Get first parameterIndex on which given Class {@code parameter} is
     * declared.
     * 

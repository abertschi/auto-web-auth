...
public class WebauthValidator
{
    ...
    /**
     * Validates an object {@code source} and colors the responding widget, if
     * constraintViolations occurs.
     * 
     * @param source object to be validated
     * @param widget widget to be colored, if errors occurred.
     */
    public Set<ConstraintViolation<Object>> validateAndColor(Object source,
            Control widget)
    {
    ...
    /**
     * Bug, hibernate validator throws exception, when field to be validated is
     * null. To count the field in this case as well, this class is used as the
     * violation.
     */
    private class ConstraintViolationStub implements
